<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cVentas.aspx.cs" Inherits="VentasCostillas.Consultas.cVentas" %>
    ...
    <div class="form-row justify-content-center">
        <asp:GridView ID="ProductoGridView" runat="server" class="table table-condensed table-bordered table-responsive" AutoGenerateColumns="False" CellPadding="4" ForeColor="#0066FF" GridLines="None">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="TotalAPagar" HeaderText="TotalAPagar" />
                ...
                <div class="modal-dialog modal-sm" style="max-width: 600px!important; min-width: 300px!important">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <%--Viewer--%>
                            <rsweb:ReportViewer ID="VentasReportViewer" runat="server" ProcessingMode="Remote" Height="400px" Width="500px">
